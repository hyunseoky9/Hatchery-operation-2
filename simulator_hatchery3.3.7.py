...
def simulator_hatchery3_3_7():
    # Set the seed
    seednum = 356455 # np.random.randint(0, 1000000) #671370
    ...
    envobsvars = ['logcatch_r_apr','logcatch_r_oct','logcatch_r_nov','logcatch_r_apr+nov','logcatch_r_sep+oct','logcatch_r_aug+sep+oct','logcatch_r_jul+aug+sep+oct','logmaxcatch_r_apr','logmaxcatch_r_oct',
                'logmaxcatch_r_nov','effort_r_apr','effort_r_oct','effort_r_nov','effort_r_apr+nov','effort_r_jul+aug+sep+oct','logcpue_r_apr','logcpue_r_oct',
                'logcpue_r_nov','logcpue_r_apr+nov','numsamples_r_apr','numsamples_r_jul','numsamples_r_aug','numsamples_r_sep','numsamples_r_oct','numsamples_r_nov','numsamples_r_jul+aug+sep','numsamples_r_jul+aug+sep+oct','numsamples_r_apr+may+jun+jul+aug+sep+oct','prop0_r_apr','prop0_r_oct',
                ...
                'logecatch_r_nov','logecatch_r_apr+nov','logecatch_r_jul+aug+sep+oct','logecatch_r_sep+oct','logecatch_r_aug+sep+oct','logecatch_r_jul+aug+sep+oct']
