...
class Hatchery3_3_2_2:
    ...
    def step(self, a, current_strategy = 0):
        ...
        if self.discset == -1:
            ...
            self.state = np.concatenate([logN0_next, logN1_next, logNh_next, logq_next, logNe_next, t_next])
            self.obs = np.concatenate([logN0_next, logN1_next, logNh_next, logqhat_next, logNe_next, t_next])
