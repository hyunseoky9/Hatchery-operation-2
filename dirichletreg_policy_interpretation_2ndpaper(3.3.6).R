...
# Hatchery3.3.6 (perfect abundance)
...
params = c(758444,106,5) # c(780012,53,4)
filename = sprintf("G:/My Drive/research/nmsu/hatchery operation/codes/dynamic programming2/manuscript_results/simulation_fall_transitions_seed%d_paramset%d_c%d_Hatchery3.3.6.csv",params[1],params[2],params[3])
