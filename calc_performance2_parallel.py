...
def worker(policy, workerepisodenum, rms, worker_id, envinit_params, t_maxstep, fstack, action_size, device, policy_info, total_rewards,seed):
    ...
    if env.envID in ['Hatchery3.2.2', 'Hatchery3.2.3','Hatchery3.2.4','Hatchery3.2.5','Hatchery3.2.6','Hatchery3.2.7','Hatchery3.3.1','Hatchery3.3.2','Hatchery3.3.2.2','Hatchery3.3.3','Hatchery3.3.4','Hatchery3.3.5','Hatchery3.4.1']:
